...
var tr = function(t3) {
  ...
  function s3(t4) {
    ...
    return he(this, s3), ye(ke(i2 = a3.call(this, t4)), "getPreSelection", function() {
      ...
      if (i2.props.shouldCloseOnSelect && !i2.props.showTimeSelect && i2.sendFocusBackToInput(), i2.props.onChangeRaw && i2.props.onChangeRaw(t5), i2.setSelected(e3, t5, false, r2), i2.props.showDateSelect && i2.setState({ isRenderAriaLiveMessage: true }), !i2.props.shouldCloseOnSelect || i2.props.showTimeSelect) i2.setPreSelection(e3);
      ...
      if ("Enter" === t5) e3.preventDefault(), i2.handleSelect(r2, e3), !i2.props.shouldCloseOnSelect && i2.setPreSelection(r2);
      else if ("Escape" === t5) e3.preventDefault(), i2.setOpen(false), i2.inputOk() || i2.props.onInputError({ code: 1, msg: er });
        ...
        if (!n) return void (i2.props.onInputError && i2.props.onInputError({ code: 1, msg: er }));
